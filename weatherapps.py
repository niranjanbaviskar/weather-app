...
def data_get():
    city = city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=53b89538be0e2f3954cdd5eb2eba173c").json()
...
city_name = StringVar()
list_name = ["Andhra Pradesh","Arunachal Pradesh ","Assam","Bihar","Chhattisgarh","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka","Kerala","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Odisha","Punjab","Rajasthan","Sikkim","Tamil Nadu","Telangana","Tripura","Uttar Pradesh","Uttarakhand","West Bengal","Andaman and Nicobar Islands","Chandigarh","Dadra and Nagar Haveli","Daman and Diu","Lakshadweep","National Capital Territory of Delhi","Puducherry","Mumbai","Pune","Nagpur","Nashik","Aurangabad","Solapur","Amravati","Kolhapur","Thane","Akola","Latur","Dhule","Ahmednagar","Jalgaon","Nanded","Sangli","Satara","Malegaon","Osmanabad","Nandurbar","Wardha","Yavatmal","Chandrapur","Parbhani","Buldana","Gondia","Hingoli","Washim","Beed","Jalna","Gadchiroli","Ratnagiri","Sindhudurg","Bhandara","Wardha"]
...
press_label = Label(win, text="Pressure", font=("Time New Roman", 20))
press_label.place(x=25,y=470,height=50,width=210)
press_label1 = Label(win, text="", font=("Time New Roman", 20))
